// Задний тайлмап для красоты в эдиторе
...
public class M3EditorBackgroundTilemap : MonoBehaviour
{
    // тайлмап
    [SerializeField]
    ...
    // удаление на позиции
    public void RemoveAt(M3Pos pos)
    {
        tilemap.SetTile(new Vector3Int(pos.X, pos.Y), null);
    }
